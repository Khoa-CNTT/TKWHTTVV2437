          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="">
              ...
              <h1 className="text-2xl font-bold mb-4">
                Đặt phòng của bạn ở {property?.data.propertyAddress.city} đã
                được xác nhận.
              </h1>
            ...
            <div>
              ...
              <div className="my-10 border-y border-t-gray-200 border-b-gray-200 py-6 flex flex-col gap-4">
                ...
                <p className="text-[-14] ">
                  Đối với hầu hết các câu hỏi, chỗ nghỉ là nơi tốt nhất để liên
                  hệ
                </p>
    ...
    return (
      <div className="flex items-center mt-6">
        ...
        <div>
          ...
          <p>
            Bạn chưa có chuyến đi nào cả. Sau khi bạn đặt chỗ, đơn đó sẽ xuất
            hiện tại đây.
          </p>
        </div>
      </div>
